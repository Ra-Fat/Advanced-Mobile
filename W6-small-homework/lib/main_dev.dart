...
import 'package:w6_2/data/repositories/appSettting/app_setting_repository_mock.dart';
...
List<SingleChildWidget> get devProviders {
  return [
    ...
    ChangeNotifierProvider<AppSettingsState>(create: (_) => AppSettingsState(repository: AppSettingRepositoryMock())..init()),
  ];
}
